...
class EmployerMobileVerification extends StatefulWidget {
  @override
  _EmployerMobileVerificationState createState() =>
      _EmployerMobileVerificationState();
}

class _EmployerMobileVerificationState
    extends State<EmployerMobileVerification> {
                      ...
                      getIntValuesSF() async {
                        ...
                        if (PreferenceOtpValue == OTPValueEntered) {
                          ...
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => EmployerProfileSection(
                                      username: username,
                                      Mobile: Mobile,
                                      Email: Email)));
                          await prefs.clear();
